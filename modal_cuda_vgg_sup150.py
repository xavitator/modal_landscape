...
plt.legend()
plt.show()
np.save("courbe/preci_train_vgg_sup150.npy", preci_train)
np.save("courbe/preci_test_vgg_sup150.npy", preci_test)
...
plt.legend()
plt.show()
np.save("courbe/preci_train_ggnet_sup150.npy", preci_train)
np.save("courbe/preci_test_ggnet_sup150.npy", preci_test)
